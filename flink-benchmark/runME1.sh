...
./flink-1.15.0/bin/flink  run  --class=de.tub.nebulastream.benchmarks.flink.manufacturingequipment.ME1 ./target/yahoo-bench-flink_2.11-0.1-SNAPSHOT.jar --parallelism $1
...
./flink-1.15.0/log/flink-pgrulich-taskexecutor-0-sr630-wn-a-55.log \
me1 \
"$1"
