...
import de.tub.nebulastream.benchmarks.flink.clustermonitoring.CMSource;
...
public class SG2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final int numOfRecords = params.getInt("numOfRecords", 10000);
        ...
        source
                ...
                .window(SlidingProcessingTimeWindows.of(Time.seconds(3600), Time.seconds(1)))
