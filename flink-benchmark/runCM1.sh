...
./flink-1.15.0/bin/flink  run  --class=de.tub.nebulastream.benchmarks.flink.clustermonitoring.CM1 ./target/yahoo-bench-flink_2.11-0.1-SNAPSHOT.jar --parallelism $1
